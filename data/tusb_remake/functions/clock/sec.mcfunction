...
## サバイバルスポナー処理
execute as @e[tag=SpawnerCore,tag=!SpawnerChecked] at @s run function tusb_race:spawner/tag
execute as @e[tag=SpawnerCore] at @s if block ~ ~ ~ minecraft:air align xyz run function tusb_race:spawner/kill
