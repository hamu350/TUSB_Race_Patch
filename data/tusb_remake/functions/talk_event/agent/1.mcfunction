...
## 初期会話
tellraw @s {"translate":"[エージェント] 転職したいカ？職業島遠いだロ？\nあんたなら無料で送ってやるヨ。どうダ？ %2$s","with":[{"score":{"name":"*","objective":"AgentWarpCost"},"color":"green","bold":true},{"text":"送っテ！","color":"aqua","bold":true,"underlined":true,"clickEvent":{"action":"run_command","value":"/trigger AgentFlag set 1"}}]}
