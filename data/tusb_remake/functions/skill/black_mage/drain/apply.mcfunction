...
### レベル１
execute if score _ ActivatedSkill matches 5240 run effect give @s minecraft:instant_damage 1 2 false
### レベル２
execute if score _ ActivatedSkill matches 5241..5249 run effect give @s minecraft:instant_damage 1 3 false
