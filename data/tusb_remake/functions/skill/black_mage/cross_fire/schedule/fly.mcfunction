...
execute positioned ~-7 ~ ~ as @e[dx=14,tag=!This,tag=!Owner,type=#tusb_remake:mob_and_player,tag=Enemy,nbt=!{ActiveEffects:[{Id:23}]}] run function tusb_remake:skill/black_mage/cross_fire/schedule/hit
execute positioned ~ ~-7 ~ as @e[dy=14,tag=!This,tag=!Owner,type=#tusb_remake:mob_and_player,tag=Enemy,nbt=!{ActiveEffects:[{Id:23}]}] run function tusb_remake:skill/black_mage/cross_fire/schedule/hit
execute positioned ~ ~ ~-7 as @e[dz=14,tag=!This,tag=!Owner,type=#tusb_remake:mob_and_player,tag=Enemy,nbt=!{ActiveEffects:[{Id:23}]}] run function tusb_remake:skill/black_mage/cross_fire/schedule/hit
