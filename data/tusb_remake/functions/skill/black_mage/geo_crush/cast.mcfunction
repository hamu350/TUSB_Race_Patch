...
execute positioned ~-15 ~-2 ~-15 as @e[dx=30,dy=4,dz=30,type=#tusb_remake:mob_and_player,tag=Enemy] at @s unless block ~ ~-1 ~ minecraft:air run function score_damage:api/attack
