...
execute if entity @s[type=player] unless score @s PlayerId = _ PlayerId run data modify storage score_damage: Argument set value {Damage:80.00,DamageType:"Projectile"}
