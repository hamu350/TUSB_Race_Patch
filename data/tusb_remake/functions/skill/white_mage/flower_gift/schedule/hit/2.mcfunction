...
item replace entity @s armor.head with minecraft:blue_orchid{display:{Name:'"白魔導士より愛を込めて"'},AttributeModifiers:[{AttributeName:generic.attack_damage,Operation:1,Slot:"head",Amount:-0.75,UUID:[I;0,2,0,1]}]}
