...
execute if score @s[type=player] PotentialSkill matches 4211 run effect give @s minecraft:instant_damage 1 3 false
execute if score @s[type=player] PotentialSkill matches 4212 run effect give @s minecraft:instant_damage 1 4 false
execute if score @s[type=player] PotentialSkill matches 4213 run effect give @s minecraft:instant_damage 1 5 false
execute if score @s[type=player] PotentialSkill matches 4214..4219 run effect give @s minecraft:instant_damage 1 6 false
