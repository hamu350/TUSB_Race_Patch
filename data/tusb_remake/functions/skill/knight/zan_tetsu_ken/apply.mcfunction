...
execute as @e[distance=..10,tag=!This,tag=!Owner,type=#tusb_remake:mob_and_player,tag=Enemy] at @s run playsound entity.wither.ambient master @a[distance=..16] ~ ~ ~ 1 2 0
execute as @e[distance=..10,tag=!This,tag=!Owner,type=#tusb_remake:mob_and_player,tag=Enemy] at @s run particle minecraft:sweep_attack ~ ~1 ~ 0.5 0.3 0.5 0 1 force
