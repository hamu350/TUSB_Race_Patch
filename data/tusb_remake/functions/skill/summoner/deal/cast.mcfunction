...
execute as @e[distance=..30,tag=!This,tag=!Owner,type=#tusb_remake:mob_and_player,tag=Enemy] at @s if block ~ ~-1 ~ #minecraft:wool run function tusb_remake:skill/summoner/deal/apply
