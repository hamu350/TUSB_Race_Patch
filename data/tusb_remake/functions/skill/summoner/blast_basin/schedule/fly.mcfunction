...
execute positioned ~-0.5 ~ ~-0.5 as @e[dy=0,tag=!This,tag=!Owner,type=#tusb_remake:mob_and_player,tag=Enemy,nbt=!{ActiveEffects:[{Id:23}]},limit=1] at @s run function tusb_remake:skill/summoner/blast_basin/schedule/hit
