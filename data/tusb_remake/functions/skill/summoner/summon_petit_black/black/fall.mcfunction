...
execute as @e[distance=..10,type=#tusb_remake:mob_and_player,nbt=!{Invulnerable:true}] rotated as @s run tp @s ~ ~1 ~ ~6 ~
...
execute positioned ~-0.5 ~1 ~-0.5 as @e[dy=0,type=#tusb_remake:mob_and_player,tag=Enemy,nbt=!{ActiveEffects:[{Id:23}]}] at @s run function tusb_remake:skill/summoner/summon_petit_black/black/hit
