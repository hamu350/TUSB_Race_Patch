...
execute as @e[distance=..5,type=#tusb_remake:mob_and_player,tag=Enemy,tag=!InKasap,sort=random,limit=3] run function tusb_remake:skill/archer/kasap_trap/schedule/apply
