...
execute as @e[distance=..6,type=#tusb_remake:mob_and_player,tag=Enemy,tag=!FallDown,nbt={OnGround:false}] at @s run function tusb_remake:skill/archer/bird_strike/hit/
