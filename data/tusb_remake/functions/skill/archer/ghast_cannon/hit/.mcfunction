...
execute if score _ PotentialSkill matches 3250 as @e[distance=..3,tag=!This,tag=Enemy,type=#tusb_remake:mob_and_player] run function score_damage:api/attack
execute if score _ PotentialSkill matches 3251..3259 as @e[distance=..6,tag=!This,tag=Enemy,type=#tusb_remake:mob_and_player] run function score_damage:api/attack
