...
execute if score _ PotentialSkill matches 3230 as @e[distance=..3,type=#tusb_remake:mob_and_player,tag=Enemy] run function tusb_remake:skill/archer/blast_shot/hit/damage1
execute if score _ PotentialSkill matches 3231..3239 as @e[distance=..6,type=#tusb_remake:mob_and_player,tag=Enemy] run function tusb_remake:skill/archer/blast_shot/hit/damage2
