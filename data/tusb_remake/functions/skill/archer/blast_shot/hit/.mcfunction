...
execute if score _ PotentialSkill matches 3230 as @e[distance=..3,tag=!This,tag=!Owner,type=#tusb_remake:mob_and_player,tag=Enemy] run function score_damage:api/attack
execute if score _ PotentialSkill matches 3231..3239 as @e[distance=..6,tag=!This,tag=!Owner,type=#tusb_remake:mob_and_player,tag=Enemy] run function score_damage:api/attack
