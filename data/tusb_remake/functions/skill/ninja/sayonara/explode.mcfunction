...
### ダメージを入れる
execute if score @s MP matches ..19 as @e[distance=..4,type=#tusb_remake:mob_and_player,tag=Enemy] run function score_damage:api/attack
execute if score @s MP matches 20..39 as @e[distance=..8,type=#tusb_remake:mob_and_player,tag=Enemy] run function score_damage:api/attack
execute if score @s MP matches 40..59 as @e[distance=..16,type=#tusb_remake:mob_and_player,tag=Enemy] run function score_damage:api/attack
execute if score @s MP matches 60..79 as @e[distance=..28,type=#tusb_remake:mob_and_player,tag=Enemy] run function score_damage:api/attack
execute if score @s MP matches 80.. as @e[distance=..40,type=#tusb_remake:mob_and_player,tag=Enemy] run function score_damage:api/attack
