...
execute if score @s Choyaku matches 2..7 as @e[distance=..3,type=#tusb_remake:mob_and_player,tag=Enemy] run function score_damage:api/attack
execute if score @s Choyaku matches 8..12 as @e[distance=..6,type=#tusb_remake:mob_and_player,tag=Enemy] run function score_damage:api/attack
execute if score @s Choyaku matches 13.. as @e[distance=..9,type=#tusb_remake:mob_and_player,tag=Enemy] run function score_damage:api/attack
