...
execute in minecraft:the_nether positioned 5 1 -24 run function tusb_remake:system/load_chunk
### チャンクロード
execute in minecraft:the_nether positioned -1854 27 -55 run function tusb_remake:system/load_chunk
execute in minecraft:the_nether positioned -1854 27 -66 run function tusb_remake:system/load_chunk
execute in minecraft:the_nether positioned -1864 27 -56 run function tusb_remake:system/load_chunk
execute in minecraft:the_nether positioned -1864 21 -65 run function tusb_remake:system/load_chunk
### ここでクリアポータルを出す
execute in minecraft:the_nether run clone -5 1 -34 5 7 -24 -1864 21 -65 masked
execute in minecraft:the_nether run fill -1854 27 -55 -1864 21 -65 minecraft:air replace minecraft:bedrock
