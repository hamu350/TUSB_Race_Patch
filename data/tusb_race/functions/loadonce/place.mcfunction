...
execute in minecraft:the_nether positioned -1850 192 -54 run setblock ~ ~ ~ end_portal_frame replace
...
execute in minecraft:the_nether positioned 0 26 20 run forceload remove ~ ~ ~ ~
...
execute in minecraft:the_nether positioned -1850 192 -54 run forceload remove ~ ~ ~ ~
