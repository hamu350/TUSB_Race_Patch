...
execute if score _ MP matches 1.. run function tusb_race:player/mp_bar/set_loop
experience add @s -40 levels

scoreboard players operation _ MP = @s MP
execute if score _ MP matches 1.. run function tusb_race:player/mp_bar/set_level
